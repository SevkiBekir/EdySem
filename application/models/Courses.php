...
<?php
    class courses extends CI_Model {
        ...
        public function insert($p_instructorId = false, $p_name = false, $p_catagoryId = false, $p_price = false, $p_isActive = false, ){
            /**
             * Assigning values...
             */
        ...
        public function update($p_instructorId = false, $p_name = false, $p_catagoryId = false, $p_price = false, $p_isActive = false, , $where){
            /**
             * Assigning values...
             */
