	...
	<div class="row">
		<div class="col-md-12">
			...
			<ul class="sf-menu">
				...
				<a href=" <?php assetsUrl(); ?>#">My Profile</a>
                	...
                	<div class="col-md-4 col-sm-6">
                    	<h5>Profile Information</h5>
                            <ul class="mega_submenu">
                                ...
                                <a href="myProfile" class="text-center">Go to Profile Details</a>
                                ...
                                <div class="row">
                                	<div class="col-xs-4">
                                     ...
                                     <div class="col-xs-8">
                                        <div class="row">
                                            <div class="col-md-12">
                                            	<div class="course_info text-center"><a href=" <?php assetsUrl(); ?><?php echo "course.php?courseId=".$courseId; ?>"><?php echo  $courseName; ?></a></div>
