	...
	if($btnPayment=="Buy it")
	{
		...
		if($chbAgreement==1)
		{
			...
			{ 
				...
				<meta http-equiv="refresh" content="6; url=course.php?courseId=<?php  echo $sessionCourseId;?>">
			<?php
			$_SESSION['paymentId']="";
			} // Credit Card Control
			else
			...
			<section id="main_content">
				...
				<meta http-equiv="refresh" content="3; url=payment.php?courseId=<?php  echo $sessionCourseId;?>">
			<?php
			}
