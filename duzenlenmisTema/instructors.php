		...
		<div class="row">
            ...
            <div class="col-md-12">
            	<div class=" box_style_3">
                	<p><img style="height:200px;" src="<?php assetsUrl(); ?><?php echo  $instructorProfileImURL; ?>" alt="Teacher" class="img-circle styled"></p>
	                ...
	                <hr>
	                <a href=" <?php assetsUrl(); ?><?php echo "profile.php?userId=$instructorId"; ?>" class="button_medium_outline">Profile</a>                      
				</div>
            </div>
