		     		...
		     		<form method="post" enctype="multipart/form-data" action="process_editProfile.php">
		     			<div class="row">
		     				<div class="col-md-6">
				 				...
				 				<p class="text-center">
					 				<img style="width:200px;height:200px;" src="<?php assetsUrl(); ?><?php echo $userProfileImageURL; ?>" alt="Teacher" class="img-circle styled">
					 			</p>
		     				</div>
		                    ...
		                    <li>
		                    	<div class="row">
				     				<div class="col-md-6">
						 				...
						 				<a href="myProfile" class="btn-lg button_fullwidth-2">Back to My profile</a>								 			
				     				</div>
