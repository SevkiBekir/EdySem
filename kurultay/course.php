...
<section id="sub-header" >
  ...
  <ol class="breadcrumb">
      ...
      <li class="active"><? echo $courseName; ?></li>
    </ol>
	 ...
	 <div class="row">
     		<div class="col-md-8">
                    ...
                    <div class="row">
                    	<div class="col-md-12">
                        	<span>You complete <strong><? echo $countCompleted; ?></strong> out of <strong><? echo $countLesson; ?></strong> lessons</span><span id="end"><i class="icon-trophy"></i></span>
                                <div class="progress">
                                    <div class="progress-bar progress-bar-info" role="progressbar" data-percentage="<? echo $percentage; ?>"></div>
                                </div>
                        </div>
	                ...
	                ?>
	                	...
	                	<div class="strip_single_course">
	                        <h4 class=" <? if($isPaid==1 || $instructorId==$userId) echo " "; else echo "btn disabled "; if($legendName=="") echo "start"; else if($legendName!="") echo $legendName; ?> "><a href="<? echo "lesson.php?lessonId=$lessonId"; ?>"><? echo $lessonName; ?></a></h4>
	                        <ul>
	                              <li><i class="icon-clock"></i> <? echo  $lessonDuration." Minutes"; ?></li>
	                              <li><i class="icon-<? if($lessonTypeName=="Text") echo "doc"; else if($lessonTypeName=="Video") echo "video"; ?>"></i><? echo $lessonTypeName; ?></li>
	                        </ul>
            ...
            <aside class="col-md-4">
            	...
            	<div class="box_style_1">
         			<h4>Lessons <span class="pull-right"><? echo $countLesson; ?></span></h4>
         			<h4>Total Duration <span class="pull-right"><? echo $totalHours." Minutes"; ?></span></h4>
                    ...
                    <div class="media">
                    	<div class="rows">
	                        <div class="col-md-4 pull-left">
	                            <img src="<? echo $instructorProImURL; ?>" style="height:50px;width:50px; margin-bottom:5%" class="img-circle" alt="">
	                        </div>
	                        <div class="col-md-8 media-body">
	                            <h5 class="media-heading"><a href="profile.php?userId=<? echo $instructorId; ?>"><? echo $instructorFName." ".$instructorLName; ?></a></h5>
	                            <p>
	                               <? echo $instructorOcName; ?>
	                            </p>
	                        </div>
                    	</div>
                    </div>
