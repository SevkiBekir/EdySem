		     		...
		     		<form method="post" enctype="multipart/form-data" action="process_editProfile.php">
		     			<div class="row">
		     				<div class="col-md-6">
				 				...
				 				<p class="text-center">
					 				<img style="width:200px;height:200px;" src="<? echo $userProfileImageURL; ?>" alt="Teacher" class="img-circle styled">
					 			</p>
		     				</div>
			            ...
			            <ul>
		                	<li>
		                     	<div class="input-group formSetting">     
								 	...
								 	<input name="txbFirstName" type="text" class="form-control" placeholder="First Name" value="<? echo $userFName; ?>"  required="true" />
								 	<input name="txbLastName"  type="text" class="form-control" placeholder="Last Name" value="<? echo $userLName; ?>" required="true"/>
							...
							<li>
		                     	<div class="input-group formSetting">     
								 	...
								 	<input name="txbEmail" type="text" class="form-control" placeholder="Email" value="<? echo $userEmail; ?>" readonly/>
								 </div>		                      
							</li>
							<li>
		                     	<div class="input-group formSetting">     
							...
							<li>
		                     	<div class="input-group formSetting">     
								 	...
								 	<input name="txbAge" type="text" class="form-control" placeholder="Your Age" value="<? if($userAge!='-') echo $userAge; ?>" />
								 </div>		                      
							</li>
							<li>
		                     	<div class="input-group formSetting">     
		                    ...
		                    <li>
		                     	<div class="input-group formSetting">     
								 	...
								 	<input name="txbTelephone" type="text" class="form-control" placeholder="Your Telephone" value="<? if($userPhone!='-') echo $userPhone; ?>" />
								 </div>		                      
							</li>
							<li>
		                     	<div class="input-group formSetting">     
								 	<span class="input-group-addon formSetting-adon">facebook.com/</span>
								 	<input name="txbFbUserName" type="text" class="form-control" placeholder="Facebook Username" value="<? if($userFbUserName!=null) echo $userFbUserName; ?>" />
								 </div>		                      
							</li>
							<li>
		                     	<div class="input-group formSetting">     
								 	<span class="input-group-addon formSetting-adon">twitter.com/</span>
								 	<input name="txbTwUserName" type="text" class="form-control" placeholder="Twitter Username" value="<? if($userTwUserName!=null) echo $userTwUserName; ?>" />
								 </div>		                      
							</li>
							<li>
		                     	<div class="input-group formSetting">     
								 	<span class="input-group-addon formSetting-adon">About</span>
								 	<textarea name="txbAbout" style="height:200px;" class="form-control" placeholder="About of You"><? if($userAbout!='-') echo $userAbout; ?>" </textarea>
								 </div>		                      
							</li>
		                    <li>
		                    	<div class="row">
