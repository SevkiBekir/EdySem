		...
		<div class="col-md-9 col-sm-9 col-xs-9">
			...
			<? if($userId!=""){?>
            	<div class="row">
                	...
                	?>
                        <img class="img-circle img-responsive" style="width:50px;height:50px;" src="<?  echo $userImageProfileURL; ?>" alt="">
                        </div>
                	...
                	<div class="col-md-4 col-sm-6">
                    	<h5>Profile Information</h5>
                            <ul class="mega_submenu">
								...
								?>
                                <center><img class="img-rounded " style="width:120px;height:120px;" src="<?  echo $userImageProfileURL; ?>" alt="" /></center>
                                <p> <h4 class="text-center"><? echo $userFName." ".$userLName; ?></h4>
                                </p>
                          ...
                          <ul class="mega_submenu">
                                ...
                                <div class="row">
                                	<div class="col-xs-4">
                                        ...
                                        <div class="photo">
                                           <img class="img-rounded" style="width:160px;height:120px;" src="<? echo $courseImageURL; ?>" alt="" />
                                     ...
                                     <div class="col-xs-8">
                                        <div class="row">
                                            <div class="col-md-12">
                                            	<div class="course_info text-center"><a href="<? echo "course.php?courseId=".$courseId; ?>"><? echo  $courseName; ?></a></div>
