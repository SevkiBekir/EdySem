...
<section id="sub-header" >
  ...
  <ol class="breadcrumb">
      ...
      <li><a href="<? echo "course.php?courseId=$getCourseId"; ?>"><? echo $courseName; ?></a></li>
	 ...
	 <div class="row">
     		<div class="col-md-4">
                <div class="plan text-center">
                        ...
                        <h2 class="plan-title"><? echo $courseName; ?></h2>
                        <p class="plan-price"><? echo $coursePrice; ?></p>
            ...
            <div class="col-md-8" style="margin-top:10px;">
            	<form method="post" action="process_payment.php">
                    ...
                    <div class="row">
						...
						<? $_SESSION['paymentId']=$getCourseId; ?>                            
                   </div><!-- End row -->
                   <div class="form-group">
                   		<div class="control-label">
                          <label class="checkbox">
                              <input type="checkbox" name="chbAgreement" value="1"> I agree <a href="termsAndConditions.php" required>terms and conditions </a>
                          </label>
                          </div>
                   </div> 
                   <div class="row">
                    	<div class="col-md-6">
                            <div class="form-group">
                            	<a href="<? echo "course.php?courseId=$getCourseId"; ?>" class="form-control btn-lg button_fullwidth-2"> Back to Course </a>    
                            </div> 
                       	</div>
