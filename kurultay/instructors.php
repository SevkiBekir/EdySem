		...
		<div class="row">
            ...
            <div class="col-md-12">
            	<div class=" box_style_3">
                	<p><img style="height:200px;" src="<? echo  $instructorProfileImURL; ?>" alt="Teacher" class="img-circle styled"></p>
                    <h4 class="p-title"><? echo $instructorFName." ".$instructorLName." <small>".$instructorOccupation."</small>"; ?></h4>
 					<p><? echo $instructorAbout; ?> </p>
	                ...
	                <hr>
	                <a href="<? echo "profile.php?userId=$instructorId"; ?>" class="button_medium_outline">Profile</a>                      
				</div>
            </div>
