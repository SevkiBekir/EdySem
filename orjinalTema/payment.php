...
<section id="sub-header" >
  ...
  <ol class="breadcrumb">
      ...
      <li><a href="<?php echo "course.php?courseId=$getCourseId"; ?>"><?php echo $courseName; ?></a></li>
            ...
            <div class="col-md-8" style="margin-top:10px;">
            	<form method="post" action="process_payment.php">
                   ...
                   <div class="row">
                    	<div class="col-md-6">
                            <div class="form-group">
                            	<a href="<?php echo "course.php?courseId=$getCourseId"; ?>" class="form-control btn-lg button_fullwidth-2"> Back to Course </a>    
                            </div> 
                       	</div>
