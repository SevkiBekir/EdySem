        ...
        <aside class="col-lg-3 col-md-4 col-sm-4">
        	...
        	<div class="box_style_1">
                ...
                <ul class="submenu-col">
                	<li><a href="<?php echo "courseList.php";if($getCatagoryId!="") echo "?catagoryId=$getCatagoryId"; ?>"><?php echo $getSearch; ?><i class="pull-right icon-off"></i> </a></li>
                </ul>
        	</div>
            <?php
            }
            ...
            <div class="box_style_1">
            	<h4>Categories</h4>
                <ul class="submenu-col">
                	 <li><a href="courseList.php<?php if($getSearch!="") echo "&search=$getSearch"; ?>" id="<?php if($getCatagoryId=="") echo "active"; ?>">All Courses <span class="badge"><?php echo $countCatagory; ?></a></li>
                <?php
	          ...
	          ?>
                    ...
                    <li><a href="<?php echo "courseList.php?catagoryId=$catagoryId"; if($getSearch!="") echo "&search=$getSearch"; ?>" id="<?php if($getCatagoryId=="$catagoryId") echo "active"; ?>"><?php echo $catagoryName." "; ?><span class="badge"><?php echo $countCatagory; ?></span></a></li>
              <?php 
						}
			  ?>
                     	...
                     	<div class="photo">
                        	 <a href="#"><img src="<?php echo $courseImageURL; ?>" alt="" /></a>
				                	...
				                	while($fetchQueryNew=mysql_fetch_array($runQueryNew))
				                	{
                                     ...
                                     ?>
                                    <div class="cat_row"><a href="<?php echo "courseList.php?catagoryId=$catagoryId"; ?>"><?php echo  $catagoryName; ?></a><span class="pull-right"><i class=" icon-clock"></i><?php echo $timeDiff. " days ago"; ?></span></div>
                                </div>
                                <div class="info">
                                    <div class="row">
                                    ...
                                    <div class="separator clearfix">
                                        ...
                                        <p > <a href="<?php echo "course.php?courseId=$courseId" ?>"><i class=" icon-list"></i> Details</a></p>
                                    </div>
                                </div>
                           </div>
                        </div>
